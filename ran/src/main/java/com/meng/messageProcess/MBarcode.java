        ...
        for (File barcode : imgs) {
            ...
            if (result != null) {
                ...
                if (barResult.startsWith("https://qm.qq.com/cgi-bin/qm/qr?k=")) {
                    ...
                    Autoreply.instance.picSearchManager.sendMsg(fromGroup, fromQQ, "群号为:" + groupNum);
                } else {
                    Autoreply.instance.picSearchManager.sendMsg(fromGroup, fromQQ, "二维码类型:" + result.getBarcodeFormat().toString() + "\n内容:" + result.getText());
                }
                return true;
            }
        }
