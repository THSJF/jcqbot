...
public class TH15GameData {
	...
	public static SpellCard[] spellcards=new SpellCard[]{
		...
		new SpellCard("「掌上的纯光」", "纯狐", SpellCard.E | SpellCard.N | SpellCard.H | SpellCard.L),
		new SpellCard("「杀意的百合」", "纯狐", SpellCard.E | SpellCard.N | SpellCard.H | SpellCard.L),
		new SpellCard("「原始的神灵界」", "纯狐", SpellCard.E | SpellCard.N),
		new SpellCard("「现代的神灵界」", "纯狐", SpellCard.H | SpellCard.L),
		new SpellCard("「战栗的寒冷之星」", "纯狐", SpellCard.E | SpellCard.N | SpellCard.H | SpellCard.L),
		new SpellCard("「纯粹的疯狂」", "纯狐", SpellCard.E | SpellCard.N | SpellCard.H | SpellCard.L),
		new SpellCard("「溢出的暇秽」", "纯狐", 7),
		new SpellCard("「地上秽的纯化」", "纯狐", SpellCard.L),
		new SpellCard("纯符「单纯的子弹地狱」", "纯狐", SpellCard.E | SpellCard.N),
		new SpellCard("纯符「纯粹的弹幕地狱」", "纯狐", SpellCard.H | SpellCard.L),
