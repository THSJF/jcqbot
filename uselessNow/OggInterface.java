...
public class OggInterface {
    ...
    public boolean processOgg(final long fromQQ, String msg) {
        ...
        if (msg.startsWith("av更新时间:")) {
            sendPrivateMessage(fromQQ, String.valueOf(ModuleManager.instance.getModule(MBiliUpdate.class).getAVLastUpdateTime(msg.substring(7))));
            return true;
        }
        if (msg.startsWith("avJson:")) {
            sendPrivateMessage(fromQQ, ModuleManager.instance.getModule(MBiliUpdate.class).getAVJson(msg.substring(7)));
            return true;
        }
        if (msg.startsWith("cv更新时间:")) {
            sendPrivateMessage(fromQQ, String.valueOf(ModuleManager.instance.getModule(MBiliUpdate.class).getCVLastUpdateTime(msg.substring(7))));
            return true;
        }
        if (msg.startsWith("cvJson:")) {
            sendPrivateMessage(fromQQ, ModuleManager.instance.getModule(MBiliUpdate.class).getCVJson(msg.substring(7)));
            return true;
        }
